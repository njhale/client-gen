...
type Flags struct {
	...
	InputDir string
	// BaseInformersPackage is the package containing informers to make KCP-aware.
...
func (f *Flags) AddTo(flagset *pflag.FlagSet) {
	...
	// TODO(kcp-dev): Does a default file path make sense for an option that normally takes a go package (e.g. "github.com/kcp-dev/code-generator/examples/pkg/generated/informers")?
	flagset.StringVar(&f.BaseInformersPackage, "base-informers-package", "/generated/informers", "package containing informers to make kcp-aware")

	// TODO(kcp-dev): The default path is suspicious here too.
